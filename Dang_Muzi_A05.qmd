...
minute_unit <- ""
second_unit <- ""
minute <- var_seconds %/% 60

second <- var_seconds %% 60

if (var_seconds == 1){
  var_second_unit <- "second"
} else {
  var_second_unit <- "seconds"
}
...
print(paste0(var_seconds, " ", var_second_unit, " is ", minute, " ", minute_unit, " and ", second, " ", second_unit, "."))
...
if (prime_check){
  print(paste(my_num, "is a prime number."))
} else {
  print(paste(my_num, "is not a prime number."))
}
...
for (i in 1:my_num){
  if (i^2 <= my_num){
    ...
    print(paste0(i, " squared is ", i^2, ", and is the first number whose square exceeds ", my_num, "."))
    break
  }
}
```
